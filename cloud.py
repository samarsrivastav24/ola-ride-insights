...
with tab2:
    ...
    "8. Avg customer rating per vehicle":
        'SELECT "Vehicle_Type",ROUND(AVG("Customer_Rating"::numeric), 1)AS avg_rating FROM  cleaned_ola_dataset GROUP BY "Vehicle_Type";',
    ...
    "10. Incomplete rides + reason":
        'SELECT "Booking_ID", "Incomplete_Rides_Reason" FROM cleaned_ola_dataset WHERE "Incomplete_Rides" != \'no\';'
